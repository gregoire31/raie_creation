...
// router.post('/getReservationByDate', function (req, res) {
...
//         dbo.collection("customers").find({ _id: ObjectId(id) }).toArray(function (err, result) {

//             if (err) throw err;

//             res.json({resultat : result.values.reservation});
...
router.post('/addReservation', function (req, res) {
    ...
    console.log(date,heureReservation,nomClient,numeroClient)
    // const reservation = {heureReservation : heureReservation,  nomClient : nomClient, numeroClient : numeroClient}
